...
namespace BugTracker.Controllers
{
    ...
    public class AdministrationController : Controller
    {
        ...
        public AdministrationController(UserManager<ApplicationUser> userManager, IWebHostEnvironment hostingEnvironment, RoleManager<IdentityRole> roleManager)
        {
        ...
        public async Task<IActionResult> DeleteRole(string id)
        {
            ...
            else
            {
                ...
                {
                    Debug.Print($"Error deleting role {ex}");
